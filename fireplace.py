...
class FireplaceControl(object):
    ...
    def __init__(self,argv):
        ...
        parser = argparse.ArgumentParser(description='Control the virtual fireplace.')
        ...
        parser.add_argument('-v','--verbose', action='store_true',
                           help='Turn on verbose debugging output? (default: False)')
    ...
    def sendRequest(self, endpoint, value):
        url = 'https://api.particle.io/v1/devices/{0}/{1}'.format(self.deviceId, endpoint)
    ...
    def turnOn(self):
        r = self.sendRequest("toggleLights", "true")

    def turnOff(self):
        r = self.sendRequest("toggleLights", "false")

    def setBrightness(self, value):
        r = self.sendRequest("brightness", str(value))
